...
public abstract class PhoneCallReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (intent.getAction().equals(com.sas_apps.callrecorder.receiver.CallRecordReceiver.ACTION_OUT)) {
            savedNumber = intent.getExtras().getString(com.sas_apps.callrecorder.receiver.CallRecordReceiver.EXTRA_PHONE_NUMBER);
        } else {
